<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="cancelordersdetails.aspx.vb" Inherits="WebApplication1.cancelordersdetails" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Cancelled Orders Details</title>
        ...
        <div class="container-fluid" style="height: 650px; margin-top: 100px;">
            <div class="row" style="margin-right: 10px; padding-top: 20px; height: 100%">
                ...
                <div class="col-sm-9" style="height: 100%;">
                    <center>
                        <h2><b style="color: white;">Cancelled Orders Details</b></h2>
                    </center>
                    <br />
                    <br />
                    <br />
