<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="testdrivedetails.aspx.vb" Inherits="WebApplication1.testdrivedetails" %>
...
<body style="color: black; background-image: url('../images/backgroundimages/testdrivedetailsbg.png'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
            ...
            <div class="container-fluid" style="height: 650px; margin-top: 100px;">
                <div class="row" style="margin-right: 10px; padding-top: 20px; height: 100%">
                    ...
                    <div class="col-sm-9" style="height: 100%;">
                        <center>
                            <h2><b style="color: white;">Test Drive Details</b></h2>
                        </center>
                        <br />
                        <br />
                        <br />
                        <center>
                            <div class="container-fluid">
                                <div style="text-align: left;" class="form-inline">
                                    <asp:TextBox ID="testdriveid" runat="server" Width="300px" placeholder="Test Drive ID" CssClass="form-control"></asp:TextBox>
                                    &nbsp; &nbsp; &nbsp;
